        ...
        <div className="max-w-6xl mx-auto space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-start">
            ...
            <div className="space-y-8 text-sm leading-relaxed tracking-wide">
              ...
              <p>
                ...
                execution, congruent pops of colors to inspire a conversation,
                and comfortable placements of landscape elements - enough for
                people to stay.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-24 items-start pt-12">
            <h2 className="text-3xl md:text-4xl font-normal leading-tight text-black col-span-2 max-w-sm">
              Our commercial projects would always involve three appealing
              aspects of our design-build system: structurally sound and
              collaborative execution, congruent pops of colors to inspire a
              conversation, and comfortable placements of landscape elements -
